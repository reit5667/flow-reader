...
## Текущий статус
**MVP:** ✅ TASK-001..022 реализованы (2026-06-28/29)  
**Активная задача:** не выбрана  
**Следующие (критические баги):** TASK-026, TASK-028, TASK-023  
**Дизайн-PRD:** TASK-029

## Известные баги (выявлены при тестировании 2026-06-29)
- TASK-023 ⏳ Свайп назад из ридера не работает (navbar скрыт)
- TASK-024 ⏳ Медленная первая загрузка книги
- TASK-025 ⏳ flibusta.is недоступна — нужно зеркало
- TASK-026 🔴 КРИТИЧНО: жест яркости сломан после фикса (регресс)
- TASK-027 ⏳ Прогресс-слайдер не скроллит страницу
- TASK-028 🔴 КРИТИЧНО: тап на шрифт ломает управление ридером (регресс)
